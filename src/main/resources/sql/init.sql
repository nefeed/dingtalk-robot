...
CREATE TABLE `task_info` (
                             ...
                             `task_content` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '任务内容',
...
CREATE TABLE `action_log` (
                              ...
                              `log` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '操作日志',
                              `gmt_create` int(11) NOT NULL COMMENT '创建时间（UnixTimestamp）10位秒数',
                              `gmt_modify` int(11) NOT NULL COMMENT '更新时间（UnixTimestamp）10位秒数',
                              `del` tinyint(1) NOT NULL DEFAULT '0' COMMENT '删除标记',
                              PRIMARY KEY (`id`),
